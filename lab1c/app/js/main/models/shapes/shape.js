...
class Shape {
    ...
    /**
     * This function returns the type of the shape, e.g. "LINES", or "TRIANGLES". The type determines which gl draw
     * method is used when rendering the shape.
     *
